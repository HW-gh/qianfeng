...
<body style="background:url(images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
    <li><a href="back/index.jsp" target="rightFrame" class="selected"><img src="images/icon01.png" title="工作台" /><h2>工作台</h2></a></li>
    ...
    <li><a href="#">关于</a></li>
    <li><a href="UserServlet?action=backExit" target="_parent">退出</a></li>
    </ul>
     
    <div class="user">
    <span>${SYS_LOGIN_USER.nick_name}</span>
    <i>消息</i>
    <b>5</b>
    </div>    
