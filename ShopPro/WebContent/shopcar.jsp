...
<body>
	...
	<script type="text/javascript">
		function jian(id){
			...
			if(count>0){
				location.href="ShopCartServlet?action=update&count="+count+"&id="+id;
			}
		};
		function jia(id){
			count=document.getElementById("count"+id).value*1+1;
			location.href="ShopCartServlet?action=update&count="+count+"&id="+id;
		};
	</script>
							...
							<ul class="item-content clearfix">
								...
								<li class="td td-info">
									<div class="item-props item-props-can">
										...
										<i class="theme-login am-icon-sort-desc">
									...
									<div class="item-price price-promo-promo">
										<div class="price-content">
											<div class="price-line">
												<em class="J_Price price-now" tabindex="0">${good.goods_price_off}</em>
											</div>
										</div>
									</div>
								</li>
								...
								<li class="td td-sum">
									<div class="td-inner">
										<em id="danPrice" tabindex="0" class="J_ItemSum number">${good.getDanPrice()}</em>
									</div>
								</li>
								<li class="td td-op">
									<div class="td-inner">
										<a href="ShopCartServlet?action=delete&id=${good.id}" data-point-url="#"
											class="delete"> 删除</a>
									</div>
								</li>
			...
			<div class="float-bar-right">
				<div class="amount-sum">
					<span class="txt">已选商品</span> <em id="getnum"></em><span
						class="txt">${ShopCart.gIList.size()}件</span>
					<div class="arrow-box">
						<span class="selected-items-arrow"></span> <span class="arrow"></span>
					</div>
				</div>
				<div class="price-sum">
					<span class="txt">合计:</span> <strong class="price"> ¥${ShopCart.getTotalPrice() }<em
						id="J_Total"></em>

					</strong>
				</div>
				<div class="btn-area">
					<a href="PayServlet?action=checkLogin" id="J_Go"
