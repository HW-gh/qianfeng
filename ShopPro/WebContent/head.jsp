			...
			<div class="am-container header">
				<ul class="message-l">
					<div class="topMessage">
						<div class="menu-hd">
						<c:if test="${USER!=null}">
							<a href="login.jsp" target="_top" class="h">${USER.nick_name},欢迎您！</a>
						</c:if>
						<c:if test="${USER==null}">
				...
				<ul class="message-r">
					...
					<div class="topMessage mini-cart">
						<div class="menu-hd"><a id="mc-menu-hd" href="shopcar.jsp" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">${ShopCart.gIList.size()}件</strong></a></div>
					</div>
						<div class="topMessage my-shangcheng">
