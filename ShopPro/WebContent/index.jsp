					...
					<div class="category-content" id="guide_2">
						<div class="category">
							<ul class="category-list" id="js_climit_li">
								<c:forEach items="${gTlist }" var="category">
									<c:if test="${category.gtype_parentid==0}">
										<li class="appliance js_toggle relative first">
											<div class="category-info">
												<h3 class="category-name b-category-name">
													<i><img src="images/${category.gtype_pic }"></i><a
														class="ml-22" title="">${category.gtype_name}</a>
												</h3>
												<em>&gt;</em>
											</div>
											...
											<div class="menu-item menu-in top">
												<div class="area-in">
													<div class="area-bg">
														<div class="menu-srot">
															<div class="sort-side">
																<c:forEach items="${gTlist}" var="temp">
																	<c:if test="${temp.gtype_parentid==category.id }">
																		<dl class="dl-sort">
																			<dt>
																				<span title="">${temp.gtype_name}</span>
																			</dt>
																			<c:forEach items="${gIlist}" var="good">
																				<c:if test="${good.goods_fatherid==temp.id }">
																					<dd>
																						<a title=""
																							href="GoodsInfoServlet?action=queryById&id=${good.id }">
				...
				<c:if test="${category.gtype_parentid==0}">
					<div id="f1">
						...
						<div class="am-g am-g-fixed floodFour">
							...
							<c:forEach items="${gIlist }" var="good">
								<c:if test="${good.goods_parentid==category.id }">
									<div class="am-u-sm-7 am-u-md-4 text-two">
										...
										<a href="GoodsInfoServlet?action=queryById&id=${good.id }"><img
											src="images/${good.goods_pic }" style="width: 160px; height: 160px" /></a>
									</div>
								</c:if>
							</c:forEach>
						</div>
