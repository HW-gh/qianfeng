	...
	<div class="listMain">
		...
		<script type="text/javascript">
			...
			function jian(){
				...
				if(count>1){
					document.getElementById("value").value=count*1-1;
				}
			};
			function jia(){
			...
			function gotoShopcar(){
				location.href="<%=request.getContextPath()%>/ShopCartServlet?action=add&count="+document.getElementById("value").value+"&id="+${good.id};
			};
		</script>
			...
			<div class="clearfixLeft" id="clearcontent">
				...
				<div class="box">
					...
					<div class="tb-booth tb-pic tb-s310">
						<a href="#"><img src="images/${good.goods_pic}"
				...
				<div class="tb-detail-list">
					...
					<div class="tb-detail-price">
						...
						<li class="price iteminfo_price">
							...
							<dd>
								<em>¥</em><b class="sys_item_price">${good.goods_price_off}</b>
							</dd>
						</li>
						<li class="price iteminfo_mktprice">
							<dt>原价</dt>
							<dd>
								<em>¥</em><b class="sys_item_mktprice">${good.goods_price}</b>
							</dd>
						</li>
						<div class="clear"></div>
					</div>
						...
						<dd>
							...
							<div class="theme-popover">
								...
								<div class="theme-popbod dform">
									<form id="buy" class="theme-signin" action="<%=request.getContextPath()%>/PayServlet?action=buynow" method="post">
											...
											<div class="theme-options">
												...
												<dd>
													<input id="min" class="am-btn am-btn-default" name=""
														type="button" value="-" onclick="jian()" />
														 <input
														id="value" name="pic" type="text" value="1"
														style="width: 30px;" />
														 <input id="add"
														class="am-btn am-btn-default" name="" type="button"
														value="+" onclick="jia()" /> <span id="Stock"
														class="tb-hidden">库存<span class="stock" id="stock">${good.goods_stock}</span>件
													</span>
												</dd>
				...
				<div class="pay">
					...
					<li>
						<div class="clearfix tb-btn tb-btn-buy theme-login">
							<a id="buy" title="点此按钮到下一步确认购买信息" onclick="buynow();" href="#">立即购买</a>
						</div>
					</li>
					<li>
						<div class="clearfix tb-btn tb-btn-basket theme-login">
							<a id="LikBasket" title="加入购物车" href="#" onclick="gotoShopcar();"><i></i>加入购物车</a>
						</div>
					</li>
				</div>
